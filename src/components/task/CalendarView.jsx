...
import { getOccurrenceDatesInRange, toLocalDateStr } from '@/utils/taskSort.js';
import { btnSmallStyle, emptyStyle } from '@/components/task/TaskStyles.js';

const WEEKDAY_LABELS = ['日','一','二','三','四','五','六'];

export default function CalendarView({ tasks, onOpenDetail, onToggle, onToggleSub, onIncrement, onRequestNewTask, onEdit, skillIconMap }) {
  ...
  const selectedTasks = selectedDate ? (occurrenceMap[selectedDate] || []) : [];
