...
const styles = {
  ...
  npc: { fontSize: 'var(--size-md)' },
  title: {
    fontSize: 'var(--font-title)', fontWeight: 800,
    color: 'var(--text, #2c1a0e)',
    margin: 0, textAlign: 'center',
  },
  desc: {
    fontSize: 'var(--font-body)', color: 'var(--text-2, #5c3d2e)',
  ...
  input: {
    ...
    fontSize: 'var(--font-title)', fontFamily: 'inherit',
    background: 'var(--bg-input, #fff)',
    color: 'var(--text, #2c1a0e)',
    outline: 'none', boxSizing: 'border-box',
  },
  error: {
    fontSize: 'var(--font-body)', color: 'var(--color-danger, #c0392b)',
