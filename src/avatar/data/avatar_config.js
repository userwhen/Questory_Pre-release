...
export const AvatarShop = [
  ...
  { id: 'face_05', name: '俏皮眨眼', price: 50, type: 'face', icon: '😉', imgId: 'face_05', rarity: 'SR' },
  { id: 'face_06', name: '俏皮眨眼', price: 50, type: 'face', icon: '😉', imgId: 'face_06', rarity: 'SR' },
  { id: 'face_07', name: '俏皮眨眼', price: 50, type: 'face', icon: '😉', imgId: 'face_07', rarity: 'R' },
  { id: 'face_08', name: '俏皮眨眼', price: 50, type: 'face', icon: '😉', imgId: 'face_08', rarity: 'SR' },
  ...
  { id: 'face_11', name: '俏皮眨眼', price: 50, type: 'face', icon: '😉', imgId: 'face_11', rarity: 'SR' },
  ...
  { id: 'acc_02', name: '魔法帽', price: 50, type: 'accessory', icon: '👒', imgId: 'acc_02', rarity: 'SR' },
  ...
  { id: 'outfit_02', name: '法師', price: 0, type: 'suit', imgId: 'outfit_02', rarity: 'R', reqAttr: { INT: 2 } },
  { id: 'outfit_03', name: '射手', price: 150, type: 'suit', imgId: 'outfit_03', rarity: 'SR', reqAttr: { STR: 2 } },
  { id: 'outfit_04', name: '刺客', price: 150, type: 'suit', imgId: 'outfit_04', rarity: 'SR', reqAttr: { AGI: 2 } },
  { id: 'outfit_05', name: '後宮 (男)', price: 150, type: 'suit', imgId: 'outfit_05', rarity: 'SSR', reqAttr: { CHR: 3 } },
  { id: 'outfit_06', name: '後宮 (女)', price: 150, type: 'suit', imgId: 'outfit_06', rarity: 'SR', reqAttr: { CHR: 3 } },
  { id: 'outfit_07', name: '男學生', price: 150, type: 'suit', imgId: 'outfit_07', rarity: 'SR' },
  { id: 'outfit_08', name: '女學生', price: 150, type: 'suit', imgId: 'outfit_08', rarity: 'SSR' },
  { id: 'outfit_09', name: '管家', price: 150, type: 'suit', imgId: 'outfit_09', rarity: 'R' },
  ...
  { id: 'outfit_14', name: '電機駭客', price: 150, type: 'suit', imgId: 'outfit_14', rarity: 'R' },
  { id: 'outfit_15', name: '貴族公子', price: 150, type: 'suit', imgId: 'outfit_15', rarity: 'SSR' },
  { id: 'outfit_16', name: '貴族千金', price: 150, type: 'suit', imgId: 'outfit_16', rarity: 'SSR' },
  ...
  { id: 'outfit_24', name: '人魚公主', price: 150, type: 'suit', imgId: 'outfit_24', rarity: 'R' },
  { id: 'outfit_25', name: '黑市刺客', price: 150, type: 'suit', imgId: 'outfit_25', rarity: 'R' },
  ...
  { id: 'comp_06', name: '女人魚(伴)', price: 150, type: 'companion', compType: 'flying', imgId: 'outfit_22', rarity: 'SSR' },
  { id: 'comp_07', name: '人魚王子(伴)', price: 150, type: 'companion', compType: 'flying', imgId: 'outfit_23', rarity: 'SSR' },
  { id: 'comp_08', name: '人魚公主(伴)', price: 150, type: 'companion', compType: 'flying', imgId: 'outfit_24', rarity: 'SSR' },
  // type: 'bg' = 整片滿版背景（不切開牆/地）；與 wall_bg / floor_bg 並存
  { id: 'bg_01', name: '翠綠森林', price: 100, type: 'bg', icon: '🌲', imgId: 'bg_01', rarity: 'SR' },
  ...
  { id: 'bg_05', name: '賽博九龍', price: 100, type: 'bg', icon: '', imgId: 'bg_05', rarity: 'SR' },
  ...
  { id: 'floor_bg_01', name: '木質地板', price: 100, type: 'floor_bg', icon: '🟫', imgId: 'floor_bg_01', rarity: 'SR' },
  { id: 'floor_bg_02', name: '磁磚地板', price: 100, type: 'floor_bg', icon: '⬜', imgId: 'floor_bg_02', rarity: 'SR' },
  ...
  { id: 'pet_05', name: '黑貓', price: 300, type: 'pet', icon: '🐈‍⬛', imgId: 'pet_05', rarity: 'SR' },
  { id: 'pet_06', name: '藍貓', price: 300, type: 'pet', icon: '🐈‍⬛', imgId: 'pet_06', rarity: 'SR' },
  { id: 'pet_07', name: '鸚鵡', price: 300, type: 'pet', icon: '🦜', imgId: 'pet_07', rarity: 'SSR' },
  { id: 'pet_08', name: '白兔', price: 300, type: 'pet', icon: '🐰', imgId: 'pet_08', rarity: 'SR' },
  { id: 'pet_09', name: '松鼠', price: 300, type: 'pet', icon: '🐹', imgId: 'pet_09', rarity: 'SR' },
  ...
  { id: 'pet_12', name: '迷你豬', price: 300, type: 'pet', icon: '🐿️', imgId: 'pet_12', rarity: 'SR' },
  { id: 'pet_13', name: '烏龜', price: 300, type: 'pet', icon: '🐢', imgId: 'pet_13', rarity: 'SR' },
